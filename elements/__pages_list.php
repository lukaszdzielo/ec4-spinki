<div class="cut__pageslist">
	<button class="cut__pageslist--button">
	...
	<ul>
		...
		<li><a href="page-onas.php">SPIN-157 O nas</a></li>
		<li><a href="page-blog.php">SPIN-158 Blog</a></li>
		...
		<li><a href="page-portfolio.php">SPIN-171 Portfolio</a></li>
	</ul>
</div>
